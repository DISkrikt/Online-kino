    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='movie/images/person/photos/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poster', models.ImageField(blank=True, null=True, upload_to='movie/images/movies/posters/')),
                ('genres', models.ManyToManyField(related_name='movies', to='movie.genre')),
                ('actors', models.ManyToManyField(related_name='acted_in_movies', to='movie.movieperson')),
                ('directors', models.ManyToManyField(related_name='directed_movies', to='movie.movieperson')),
            ],
        ),
        migrations.CreateModel(
            name='MovieReview',
